...
contract PShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 21.000.000 PShare
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 12000000 ether;
    uint256 public constant TREASURY_FUND_POOL_ALLOCATION =   3000000 ether;
    ...
    uint256 public constant VESTING_DURATION = 1000 days;
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("Pegasus Share", "SPES") {
