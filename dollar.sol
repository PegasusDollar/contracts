...
contract PESToken is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 2000 ether; // 2000 of PES

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the PES ERC-20 contract.
     */
    constructor() public ERC20("Pegasus Dollar", "PES") {
        _mint(msg.sender, 15000 ether);//  Lauchpad & Init LP & DAO fund
    }

    /**
     * @notice Operator mints PES to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of PES to mint to
